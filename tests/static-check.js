...
assert.ok(profileCustomMetricsJs.includes("{ key: 'lab', label: '检验' }") && profileCustomMetricsJs.includes("{ key: 'exam', label: '检查' }") && profileCustomMetricsJs.includes("{ key: 'electrophysiology', label: '电生理' }"), 'manual template exam types must use the agreed top-level medical categories');
